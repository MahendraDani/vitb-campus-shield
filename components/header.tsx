    ...
    return (
        <nav className="bg-[#003A6B] fixed top-0 left-0 w-full h-16 flex items-center justify-between px-4 z-[10]">
            ...
            <Link
                ...
                className="flex gap-2 py-2 px-5 font-medium bg-white border-2 border-[#003A6B] rounded-lg hover:bg-[#003A6B] hover:border-white hover:font-semibold hover:text-white transition-colors max-[580px]:hidden"
            >
            ...
            <Link
                href={"/file-a-complaint"}
                className="hidden max-[580px]:flex gap-2 py-2 px-5 font-medium bg-white rounded-lg hover:bg-[#89cff1] hover:font-semibold transition-colors"
            >
